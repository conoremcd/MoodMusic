...
<html lang="en">
	...
	<body>
		<header class="container-fluid header">
			<div class="row visible-xs-block" id="mobile-header">
				<div class="col-xs-1"></div>
				<div class="col-xs-2">
					<a href=""><img src="images/logo_placeholder.png" width="40" height="40" alt=""></a>
				</div>
				<div class="col-xs-9">
					<h5 class="lt-h horizontal align">How Do You Feel?</h5>
				</div>
			</div>
		</header>
		<div class="container-fluid pnl">
			<form action="m_player.php" method="post">        
					<div class="row pnl bmprbx">
						<div class="col-sm-3"></div>
						<div class="col-xs-4 col-sm-2 horizontal-align bmprbx">
